...
?>
<section class="relative h-64 sm:h-72 lg:h-80 w-full overflow-hidden bg-ink">
  <?php if ($image): ?>
  ...
  <div class="relative z-10 h-full max-w-site mx-auto px-4 flex items-end justify-center pb-8 sm:pb-10">
    <h1 class="text-5xl sm:text-6xl lg:text-7xl font-title uppercase tracking-wide text-white/90 text-center leading-none">
      <?= $title ?>
    </h1>
  </div>
</section>
